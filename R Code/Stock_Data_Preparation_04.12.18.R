...
#loadning data
library(data.table)
stock_data <- fread("D:\\Stock_Prediction\\data\\Non_Owner\\NonOwner_Sc_4_2018Q3_InputData.csv")
#View(stock_data)
#stock_data = data
...
stock_data1 = subset(stock_data, select = -c(Fund_id,Stock_Id,status,ClassDate) )
