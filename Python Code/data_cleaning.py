# -*- coding: utf-8 -*-
"""
Created on Thu Nov 29 18:27:01 2018

@author: Datacore
"""
##############################################################################################################################
'''
                                        Variable selection : using Extratree classifire , randomforest
'''
##############################################################################################################################
...
import os 
os.chdir("C:\\Users\\Datacore\Desktop\\Portfolio and Risk Analysis_v1\\PyCode_NON_OWNER_Prediction")
...
owner_2018q2_broaderrussel=pd.read_csv("data/NonOwner_Sc_9_2018Q3_InputData.csv")
owner_2018q2_broaderrussel.dtypes
'''
#---------------------------------description of the data------------------------------------------
'''
# Create Data Frame
owner_2018q2_broaderrussel=pd.DataFrame(owner_2018q2_broaderrussel)
#x=owner_2018q2_broaderrussel.describe()

#  No of attributes(rows and column) 
owner_2018q2_broaderrussel.shape

# attributes Name
list(owner_2018q2_broaderrussel)

# data type of the table
owner_2018q2_broaderrussel.dtypes
'''
#--------------------------------- End of description of the data-----------------------------------
'''
StockSamapleData=owner_2018q2_broaderrussel
...
final_Df=pd.concat([Char_data,st_id,df,target],axis=1)
